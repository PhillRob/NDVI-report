...
if local_test_run:
    ...
    GEOJSON_PATH = 'batch/NDVI-auto-processing/batch.geojson'
    JSON_FILE_NAME = 'batch/NDVI-auto-processing/data.json'
    SCREENSHOT_SAVE_NAME = f'batch/output/growth_decline_'
    CREDENTIALS_PATH = 'batch/credentials/credentials.json'
    REPORT_HTML = 'KKRS/NDVI-auto-processing/report.html'
    GEE_CREDENTIALS = 'ee-phill-9248b486a4bc.json'
    LOGGING = 'batch/ndvi-report-mailer.log'
    LOGO = 'bpla-systems.png'
...
if local_test_run:
    ...
    PDF_PATH = f'batch/output/{datetime.utcnow().strftime("%Y%m%d")}-{geo_data["name"]}-Vegetation-Cover-Report.pdf'
